...
<div class="row mb-6">
              ...
              <div class="row">
                ...
                <!--end::Col-->
                 ...
                 <div class="col-lg-6 fv-row">
                  ...
                  <div class="fv-plugins-message-container">
                    <div class="fv-help-block">
                      <ErrorMessage name="sname Arabic" />
                    </div>
                  </div>
                </div>
                <!--end::Col-->
                ...
                <div class="col-lg-6 fv-row">
                  ...
                  <div class="fv-plugins-message-container">
                    <div class="fv-help-block">
                      <ErrorMessage name="lname Arabic" />
                    </div>
                  </div>
                </div>
                <!--end::Col-->
          ...
          <div class="row mb-6">
            <!--begin::Label-->
            <label class="col-lg-4 col-form-label fw-semibold fs-6">
              <span class="">Situation Familiale</span>
            ...
            <div class="col-lg-8 fv-row">
              <Field
                ...
                v-model="profileDetails.SituationFamiliale"
              >
              ...
              <div class="fv-plugins-message-container">
                <div class="fv-help-block">
                  <ErrorMessage name="Situation Familiale" />
                </div>
              </div>
            </div>
            <!--end::Col-->
          ...
          <div class="row mb-6">
            <!--begin::Label-->
            <label class="col-lg-4 col-form-label fw-semibold fs-6">
              <span class="">Nombre d'enfant</span>
            ...
            <div class="col-lg-8 fv-row">
              <Field
                ...
                class="form-select form-select-solid form-select-lg fw-semibold"
                v-model="profileDetails.nombreEnfants"
              >
              ...
              <div class="fv-plugins-message-container">
                <div class="fv-help-block">
                  <ErrorMessage name="Nombre d'enfants" />
                </div>
              </div>
            </div>
            <!--end::Col-->
